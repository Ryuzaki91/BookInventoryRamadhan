package id.sch.smktelkom_mlg.ramadhan_kurniawan.fragment;
...
import id.sch.smktelkom_mlg.ramadhan_kurniawan.R;
import id.sch.smktelkom_mlg.ramadhan_kurniawan.activity.BookFormActivity;
import id.sch.smktelkom_mlg.ramadhan_kurniawan.adapter.BooksAdapter;
import id.sch.smktelkom_mlg.ramadhan_kurniawan.adapter.DividerDecoration;
import id.sch.smktelkom_mlg.ramadhan_kurniawan.database.Book_DAO;
import id.sch.smktelkom_mlg.ramadhan_kurniawan.helper.HelperFunction;
import id.sch.smktelkom_mlg.ramadhan_kurniawan.model.Book;
import id.sch.smktelkom_mlg.ramadhan_kurniawan.rest.ApiClient;
import id.sch.smktelkom_mlg.ramadhan_kurniawan.rest.BookService;
import id.sch.smktelkom_mlg.ramadhan_kurniawan.rest.GeneralResponse;
